...
public enum Qualities
{
    ...
    ANIMAL_POLYGOT(0,-1,0,0,1,0,1,0,0,0,true,"Similar to the Magical Polyglot effect, a magical aura hangs over the settlement. All creatures of the Animal type gain the ability to speak and think while within the settlement's borders. Animals act as if their INT scores were 6, and gain ability to speak Common; they lose these benefits as soon as they pass the settlement's borders. There are likely to be few butcher shops within the settlement's borders…. Add the settlement's Lore modifier to Handle Animal checks made within the settlement."),
