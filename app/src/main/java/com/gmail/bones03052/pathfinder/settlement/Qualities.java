...
public enum Qualities
{
    ...
    private Qualities(double corruption,double productivity,double society,double law,double lore,double crime,double sp,double bvm,double pm,int special,double danger,String specialText)
    {
